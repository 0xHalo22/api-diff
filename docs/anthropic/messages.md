...
last-fetched: 2026-08-25T15:27:26+00:00
...
content: array of [BashCodeExecutionOutputBlock](/docs/en/api/http/messages#bash_code_execution_output_block) { file\_id, type }
...
content: array of [BashCodeExecutionOutputBlockParam](/docs/en/api/http/messages#bash_code_execution_output_block_param) { file\_id, type }
...
BrowserStateChange = [BrowserStateChangeTabOpened](/docs/en/api/http/messages#browser_state_change_tab_opened) { tab\_id, type } or [BrowserStateChangeDownloadStarted](/docs/en/api/http/messages#browser_state_change_download_started) { download\_id, type, url } or [BrowserStateChangeDownloadCompleted](/docs/en/api/http/messages#browser_state_change_download_completed) { download\_id, type, url, 2 more } or [BrowserStateChangeDownloadFailed](/docs/en/api/http/messages#browser_state_change_download_failed) { download\_id, type, url, error }
...
content: array of [CodeExecutionOutputBlock](/docs/en/api/http/messages#code_execution_output_block) { file\_id, type }
...
content: array of [CodeExecutionOutputBlockParam](/docs/en/api/http/messages#code_execution_output_block_param) { file\_id, type }
...
CodeExecutionToolResultBlockContent = [CodeExecutionToolResultError](/docs/en/api/http/messages#code_execution_tool_result_error) { error\_code, type } or [CodeExecutionResultBlock](/docs/en/api/http/messages#code_execution_result_block) { content, return\_code, stderr, 2 more } or [EncryptedCodeExecutionResultBlock](/docs/en/api/http/messages#encrypted_code_execution_result_block) { content, encrypted\_stdout, return\_code, 2 more }
...
CodeExecutionToolResultBlockParamContent = [CodeExecutionToolResultErrorParam](/docs/en/api/http/messages#code_execution_tool_result_error_param) { error\_code, type } or [CodeExecutionResultBlockParam](/docs/en/api/http/messages#code_execution_result_block_param) { content, return\_code, stderr, 2 more } or [EncryptedCodeExecutionResultBlockParam](/docs/en/api/http/messages#encrypted_code_execution_result_block_param) { content, encrypted\_stdout, return\_code, 2 more }
...
skills: array of [ContainerSkill](/docs/en/api/http/messages#container_skill) { skill\_id, type, version } or null
...
skills: optional array of [SkillParams](/docs/en/api/http/messages#skill_params) { skill\_id, type, version } or null
...
ContentBlock = [TextBlock](/docs/en/api/http/messages#text_block) { citations, text, type } or [ThinkingBlock](/docs/en/api/http/messages#thinking_block) { signature, thinking, type } or [RedactedThinkingBlock](/docs/en/api/http/messages#redacted_thinking_block) { data, type } or 9 more
...
ContentBlockParam = [TextBlockParam](/docs/en/api/http/messages#text_block_param) { text, type, cache\_control, citations } or [ImageBlockParam](/docs/en/api/http/messages#image_block_param) { source, type, cache\_control, transformations } or [DocumentBlockParam](/docs/en/api/http/messages#document_block_param) { source, type, cache\_control, 3 more } or 13 more
...
ContentBlockSourceContent = [TextBlockParam](/docs/en/api/http/messages#text_block_param) { text, type, cache\_control, citations } or [ImageBlockParam](/docs/en/api/http/messages#image_block_param) { source, type, cache\_control, transformations }
...
MessageCountTokensTool = [Tool](/docs/en/api/http/messages#tool) { input\_schema, name, allowed\_callers, 7 more } or [ToolBash20250124](/docs/en/api/http/messages#tool_bash_20250124) { name, type, allowed\_callers, 4 more } or [CodeExecutionTool20250522](/docs/en/api/http/messages#code_execution_tool_20250522) { name, type, allowed\_callers, 3 more } or 18 more
...
format: optional [JSONOutputFormat](/docs/en/api/http/messages#json_output_format) { schema, type } or null
...
RawContentBlockDelta = [TextDelta](/docs/en/api/http/messages#text_delta) { text, type } or [InputJSONDelta](/docs/en/api/http/messages#input_json_delta) { partial\_json, type } or [CitationsDelta](/docs/en/api/http/messages#citations_delta) { citation, type } or 2 more
...
message: [Message](/docs/en/api/http/messages#message) { id, container, content, 7 more }
...
RawMessageStreamEvent = [RawMessageStartEvent](/docs/en/api/http/messages#raw_message_start_event) { message, type } or [RawMessageDeltaEvent](/docs/en/api/http/messages#raw_message_delta_event) { delta, type, usage } or [RawMessageStopEvent](/docs/en/api/http/messages#raw_message_stop_event) { type } or 3 more
...
TextCitation = [CitationCharLocation](/docs/en/api/http/messages#citation_char_location) { cited\_text, document\_index, document\_title, 4 more } or [CitationPageLocation](/docs/en/api/http/messages#citation_page_location) { cited\_text, document\_index, document\_title, 4 more } or [CitationContentBlockLocation](/docs/en/api/http/messages#citation_content_block_location) { cited\_text, document\_index, document\_title, 4 more } or 2 more

One of the following:



TextCitationParam = [CitationCharLocationParam](/docs/en/api/http/messages#citation_char_location_param) { cited\_text, document\_index, document\_title, 3 more } or [CitationPageLocationParam](/docs/en/api/http/messages#citation_page_location_param) { cited\_text, document\_index, document\_title, 3 more } or [CitationContentBlockLocationParam](/docs/en/api/http/messages#citation_content_block_location_param) { cited\_text, document\_index, document\_title, 3 more } or 2 more
...
ThinkingConfigParam = [ThinkingConfigEnabled](/docs/en/api/http/messages#thinking_config_enabled) { budget\_tokens, type, display } or [ThinkingConfigDisabled](/docs/en/api/http/messages#thinking_config_disabled) { type } or [ThinkingConfigAdaptive](/docs/en/api/http/messages#thinking_config_adaptive) { type, display }
...
tool\_references: array of [ToolReferenceBlock](/docs/en/api/http/messages#tool_reference_block) { tool\_name, type }
...
ToolUnion = [Tool](/docs/en/api/http/messages#tool) { input\_schema, name, allowed\_callers, 7 more } or [ToolBash20250124](/docs/en/api/http/messages#tool_bash_20250124) { name, type, allowed\_callers, 4 more } or [CodeExecutionTool20250522](/docs/en/api/http/messages#code_execution_tool_20250522) { name, type, allowed\_callers, 3 more } or 18 more
...
content: [DocumentBlock](/docs/en/api/http/messages#document_block) { citations, source, title, type }
...
content: [DocumentBlockParam](/docs/en/api/http/messages#document_block_param) { source, type, cache\_control, 3 more }
...
WebSearchToolResultBlockContent = [WebSearchToolResultError](/docs/en/api/http/messages#web_search_tool_result_error) { error\_code, type } or array of [WebSearchResultBlock](/docs/en/api/http/messages#web_search_result_block) { encrypted\_content, page\_age, title, 2 more }
...
WebSearchToolResultBlockParamContent = array of [WebSearchResultBlockParam](/docs/en/api/http/messages#web_search_result_block_param) { encrypted\_content, title, type, 2 more } or [WebSearchToolRequestError](/docs/en/api/http/messages#web_search_tool_request_error) { error\_code, type }
