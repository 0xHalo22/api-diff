...
name: GitHub REST API — Rate Limits
last-fetched: 2026-05-08T15:17:16+00:00
...
## [Get rate limit status for the authenticated user](#get-rate-limit-status-for-the-authenticated-user)
...
### [fine\_grained\_access](#get-rate-limit-status-for-the-authenticated-user--fine-grained-access-tokens)

works\_with\_fine\_grained\_tokens:

- [user\_access\_token\_name](/en/apps/creating-github-apps/authenticating-with-a-github-app/generating-a-user-access-token-for-a-github-app)
- [installation\_access\_token\_name](/en/apps/creating-github-apps/authenticating-with-a-github-app/generating-an-installation-access-token-for-a-github-app)
- [fine\_grained\_access\_token\_name](/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens#creating-a-fine-grained-personal-access-token)

no\_permission\_sets

allows\_public\_read\_access\_no\_permissions

### [http\_status\_code](#get-rate-limit-status-for-the-authenticated-user--status-codes)
...
### [code\_samples](#get-rate-limit-status-for-the-authenticated-user--code-samples)
...
copy\_to\_clipboard curl request example
