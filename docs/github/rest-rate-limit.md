...
### [Fine-grained access tokens for "Get rate limit status for the authenticated user"](#get-rate-limit-status-for-the-authenticated-user--fine-grained-access-tokens)
...
### [HTTP response status codes for "Get rate limit status for the authenticated user"](#get-rate-limit-status-for-the-authenticated-user--status-codes)
...
### [Code samples for "Get rate limit status for the authenticated user"](#get-rate-limit-status-for-the-authenticated-user--code-samples)
